...
from models import ndmps_fs_rhythmic_spa_frontend
importlib.reload(ndmps_fs_rhythmic_spa_frontend)
from models.ndmps_fs_rhythmic_spa_frontend import generate
...
for input_signal in input_signals:
    ...
    with model:
        ...
        probe = nengo.Probe(ndmps_r.output, synapse=.01, sample_every=.005)
        ndmps_r.product_x.sq1.add_neuron_output()
        ndmps_r.product_y.sq1.add_neuron_output()
        probe_product_x = nengo.Probe(
            ndmps_r.product_x.sq1.neuron_output, synapse=None)
        probe_product_y = nengo.Probe(
            ndmps_r.product_y.sq1.neuron_output, synapse=None)
